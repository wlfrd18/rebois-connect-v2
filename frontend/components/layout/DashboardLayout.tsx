...
{user && (
  <Link href={`/dashboard/profile/${user.username}`} className="px-4 py-3 border-b border-green-800 flex items-center gap-3 hover:bg-green-800 transition cursor-pointer">
