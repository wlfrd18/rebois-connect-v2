    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-6 flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <a href="#mission" className="border border-white/40 text-white hover:bg-white/10 font-medium px-8 py-4 rounded-full text-lg transition">Découvrir la mission</a>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold mb-6 leading-tight">Née d&apos;un engagement terrain de plus de 20 ans</h2>
              <p className="text-green-100 text-lg leading-relaxed mb-5">
                ...
                L&apos;<strong className="text-white">ONG Teck Ivoire</strong> œuvre depuis des années à la reforestation par la culture du teck à travers toute la Côte d&apos;Ivoire.
              </p>
              <p className="text-green-100 text-lg leading-relaxed mb-8">
                C&apos;est cette expérience terrain qui a inspiré la création de Rebois Connect : une plateforme pour démocratiser et structurer le financement de la reforestation à l&apos;échelle mondiale.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 bg-white/10 border border-white/20 rounded-2xl p-4 text-center">
                <div className="text-xs text-green-300 italic">&ldquo;La culture du teck conjugue rentabilité, écologie et reboisement.&rdquo;</div>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-3xl mx-auto px-6">
          ...
          <p className="text-green-200 text-xl mb-10 leading-relaxed">Rejoignez des centaines de volontaires, mécènes et structures qui œuvrent chaque jour pour reverdir notre planète.</p>
