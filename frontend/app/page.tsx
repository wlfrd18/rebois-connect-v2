...
import { TreePine, Users, Award, ShieldCheck, ArrowRight, Globe, ExternalLink } from "lucide-react";
...
// Stats réelles de l'ONG Teck Ivoire — partenaire fondateur
const ONG_STATS = [
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-6 flex flex-col items-center">
          <div className="flex justify-center mb-8">
            <Image src="/logo.png" alt="Rebois Connect" width={180} height={65}
              className="object-contain brightness-0 invert" />
          </div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight tracking-tight">
            Reboisez la planète,<br />
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-3 max-w-3xl mx-auto leading-relaxed">
            La plateforme qui connecte propriétaires fonciers, mécènes et structures de reforestation
            pour restaurer les écosystèmes dégradés à travers le monde.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Link href="/register"
              className="bg-green-500 hover:bg-green-400 text-white font-semibold px-8 py-4 rounded-full text-lg transition flex items-center gap-2 justify-center shadow-lg shadow-green-500/30">
              Commencer maintenant <ArrowRight size={20} />
            </Link>
            <a href="#mission"
              className="border border-white/40 text-white hover:bg-white/10 font-medium px-8 py-4 rounded-full text-lg transition">
              Découvrir la mission
            </a>
          </div>

          {/* Stats — SOUS les boutons, bien espacées */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-3xl">
            {[
              { value: "2 034+", label: "Hectares reboisés" },
              { value: "204",    label: "Villages impactés" },
              { value: "64",     label: "Départements" },
          ...
          <p className="text-xs text-gray-500 mt-3">
            ...
            <a href="https://www.ongteckivoire.org" target="_blank" rel="noopener noreferrer"
              className="text-green-400 hover:underline">ONG Teck Ivoire</a>,
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-6 leading-tight">
                Restaurer les forêts dégradées à l'échelle mondiale
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-5">
                Rebois Connect est né d'un constat simple : des millions d'hectares de terres dégradées
                existent partout dans le monde, pendant que des entreprises et des particuliers cherchent
                à compenser leur empreinte carbone.
              </p>
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                Notre plateforme crée le lien manquant entre propriétaires de terres, financeurs et
                experts en reforestation — pour transformer des terres improductives en forêts certifiées.
              </p>
      ...
      {/* Section ONG Teck Ivoire — origine du projet */}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold mb-6 leading-tight">
                Née d'un engagement terrain de plus de 20 ans
              </h2>
              <p className="text-green-100 text-lg leading-relaxed mb-5">
                Rebois Connect a été co-fondée par un acteur pionnier du reboisement en Côte d'Ivoire.
                L'<strong className="text-white">ONG Teck Ivoire</strong> — organisation partenaire fondatrice —
                œuvre depuis des années à la reforestation par la culture du teck à travers toute la Côte d'Ivoire.
              </p>
              <p className="text-green-100 text-lg leading-relaxed mb-8">
                C'est cette expérience terrain, cette connaissance des enjeux réels du reboisement et
                des obstacles auxquels font face propriétaires fonciers et investisseurs, qui a inspiré
                la création de Rebois Connect : une plateforme pour démocratiser et structurer le financement
                de la reforestation à l'échelle mondiale.
              </p>
              <a href="https://www.ongteckivoire.org" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white text-green-800 font-semibold px-6 py-3 rounded-full hover:bg-green-50 transition">
                Visiter ONG Teck Ivoire <ExternalLink size={16} />
              </a>
            </div>

            {/* Stats ONG Teck Ivoire */}
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 bg-white/10 border border-white/20 rounded-2xl p-4 text-center">
                <div className="text-xs text-green-300 italic">
                  "La culture du teck est un puissant facteur de reforestation qui conjugue rentabilité,
                  écologie et reboisement."
                </div>
                <div className="text-xs text-green-400 mt-2 font-medium">— ONG Teck Ivoire, Côte d'Ivoire</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              De la soumission du terrain à la certification CO₂, chaque étape est vérifiée et traçable.
            </p>
          </div>
          <div className="grid md:grid-cols-4 gap-6">
            {FEATURES.map((f, i) => (
              <div key={i}
                ...
                <div className="w-12 h-12 bg-green-50 rounded-xl flex items-center justify-center text-green-700 mb-4">
                  {f.icon}
                </div>
      ...
      <section id="roles" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {ROLES.map((r) => (
              <div key={r.role}
                className={`bg-gradient-to-br ${r.color} rounded-3xl p-8 text-white hover:scale-[1.02] transition-transform`}>
                ...
                <Link href="/register"
                  className="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white font-medium px-5 py-2.5 rounded-full transition text-sm">
      ...
      <section className="relative py-32 overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1476231682828-37e571bc172f?w=1920&q=80"
          alt="Forêt"
        ...
        <div className="relative z-10 text-center text-white max-w-3xl mx-auto px-6">
          ...
          <p className="text-green-200 text-xl mb-10 leading-relaxed">
            Rejoignez des centaines de volontaires, mécènes et structures qui œuvrent chaque jour
            pour reverdir notre planète.
          </p>
          <Link href="/register"
            className="bg-green-500 hover:bg-green-400 text-white font-bold px-10 py-5 rounded-full text-xl transition inline-flex items-center gap-3 shadow-xl shadow-green-900/50">
      ...
      <footer className="bg-gray-900 text-gray-400 py-12">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
            <Image src="/logo.png" alt="Rebois Connect" width={120} height={44}
          ...
          <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-sm">
            <p>© 2026 Rebois Connect. Tous droits réservés.</p>
            <p className="text-gray-600">
              Inspiré par l'action terrain de{" "}
              <a href="https://www.ongteckivoire.org" target="_blank" rel="noopener noreferrer"
